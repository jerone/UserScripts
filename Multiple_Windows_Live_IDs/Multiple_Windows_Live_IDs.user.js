		...
		window.setTimeout(function() {
			...
			editAccountDiv.innerHTML =
				...
				'<div id="i0272" class="signInHeader" style="height: 80px;">' +
					'<h1><img src="' + imageHeader + '" alt="Multiple Windows Live IDs" /></h1>' +
				'</div>' +
				...
				'<div style="width: 320px;" class="floatLeft">' +
					...
					'<div class="signUpFloat">Multiple Windows Live IDs. <a class="TextSemiBold" href="https://github.com/jerone/UserScripts/tree/master/Multiple_Windows_Live_IDs_2" target="_blank">More info...</a></div>' +
				'</div>';
			...
			if (addPassMask) { addPassMaskFn(document.getElementById("i0118")); }  // Microsoft password;
		}, 100);
	});
})();
